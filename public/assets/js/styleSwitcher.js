...
function addSwitcher()
{
	...
	// var demoPanel = '<div class=dlab-demo-panel><div class=bg-close></div><a class=dlab-demo-trigger href=javascript:void(0) data-original-title="Check out more demos"data-placement=right data-toggle=tooltip><span><i class="las la-tint"></i></span></a><div class=dlab-demo-inner><a class="btn btn-sm btn-primary mb-3 px-2 py-1"href=javascript:void(0); onclick=deleteAllCookie()>Delete All Cookie</a><div class=dlab-demo-header><h4>Select A Demo</h4><a class=dlab-demo-close href=javascript:void(0)><span><i class="las la-times"></i></span></a></div><div class=dlab-demo-content><div class=dlab-wrapper><div class="rounded-lg dlab-demo-bx overlay-bx demo-active"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic15.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 1</a></div></div><h5 class=text-black>Dashboard 1</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic16.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 2</a></div></div><h5 class=text-black>Dashboard 2</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic9.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 3</a></div></div><h5 class=text-black>Dashboard 3</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic10.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 4</a></div></div><h5 class=text-black>Dashboard 4</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic11.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 5</a></div></div><h5 class=text-black>Dashboard 5</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic12.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 6</a></div></div><h5 class=text-black>Dashboard 6</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic13.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 7</a></div></div><h5 class=text-black>Dashboard 7</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic14.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2"href=index.html>Dashboard 8</a></div></div><h5 class=text-black>Dashboard 8</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic1.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=1>Default</a></div></div><h5 class=text-black>Demo 1</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic2.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=2>Default</a></div></div><h5 class=text-black>Demo 2</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic3.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=3>Default</a></div></div><h5 class=text-black>Demo 3</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic4.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=4>Default</a></div></div><h5 class=text-black>Demo 4</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic5.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=5>Default</a></div></div><h5 class=text-black>Demo 5</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic6.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=6>Default</a></div></div><h5 class=text-black>Demo 6</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic7.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=7>Default</a></div></div><h5 class=text-black>Demo 7</h5><hr><div class="rounded-lg dlab-demo-bx overlay-bx"><div class="rounded-lg overlay-wrapper"><img alt=""class=w-100 src=assets/images/demo/pic8.jpg></div><div class=overlay-layer><a class="btn btn-sm btn-secondary mr-2 dlab_theme_demo"href=javascript:void(0); data-theme=8>Default</a></div></div><h5 class=text-black>Demo 8</h5></div></div><div class=note-text><span class=text-danger>*Note :</span>This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a class=text-primary href=https://dompet.dexignlab.com/doc/ target=_blank>documentation.</a></div></div></div>';
