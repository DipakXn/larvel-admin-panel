...
<script src="https://cdn.tiny.cloud/1/h79mn5jz3z7me1h067wbm6n4jlr70r6lmxtfpxcm8zoiindw/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<script>
  tinymce.init({
    selector: '#editor',
    height: 500,
    plugins: 'code',
    relative_urls: false,  // This prevents TinyMCE from converting URLs to relative
    remove_script_host: false,  // This prevents TinyMCE from removing the domain part of the URL
    ...
    setup: function (editor) {
      editor.on('change', function () {
        updateVisualPreview(editor.getContent());
      });
    }
  });

  function updateVisualPreview(html) {
    document.getElementById('visual-preview').innerHTML = html;
  }
</script>
</head>
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo me-5" href="{{route ('dashboard') }}"><img
                        src="{{ asset('dashboard-assets/images/logo.svg') }}" class="me-2" alt="logo" /></a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('products.index') }}">View Product</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="{{ route('logout') }}"
                            onclick="event.preventDefault(); if(confirm('Are you sure you want to logout?')) { document.getElementById('logout-form').submit(); }">
                            <i class="ti-power-off menu-icon"></i>Logout
                        </a>
                    </li>
                </ul>
            </nav>