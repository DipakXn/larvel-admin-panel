...
<head>
    ...
    <link href="https://dompet.dexignlab.com/xhtml/page-error-404.html" rel="stylesheet" type="text/css"/>
					...
					<div class="collapse navbar-collapse justify-content-between">
						...
						<ul class="navbar-nav header-right">
                            ...
                            @csrf
								...
								<a href="javascript:void(0);" class="btn btn-primary d-sm-inline-block d-none logout-link">Log Out <i class="fa-solid fa-right-from-bracket ms-3 scale5"></i></a>
							</li>
						</ul>
					</div>
				</nav>
				...
				<ul class="metismenu" id="menu">
					<li class="dropdown header-profile">
						<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
							<!-- <img src="assets/images/profile/pic1.jpg" width="10" alt=""> -->
						...
						<div class="dropdown-menu dropdown-menu-end">
							<a href="{{ route('profile') }}" class="dropdown-item ai-icon">
								<svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" style="display:inline;"
							...
							<a href="{{ route('logout') }}" class="dropdown-item ai-icon logout-link">
								<svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" style="display:inline;"
									height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
									stroke-linecap="round" stroke-linejoin="round">
					...
					<li><a class="has-arrow ai-icon" href="{{ route('products.index') }}" aria-expanded="false">
							<i class="fa-brands fa-product-hunt fw-bold"></i>
